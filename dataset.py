...
class TrainSetLoader(Dataset):
    ...
    def __getitem__(self, idx):
        try:
            img = Image.open((self.dataset_dir + '/image/' + self.train_list[idx] + '.png').replace('//', '/')).convert(
                'I')  # read image base on version ”I“
            # img = Image.open((self.dataset_dir + '/image/' + self.train_list[idx] + '.png').replace('//','/'))
            mask = Image.open((self.dataset_dir + '/mask/' + self.train_list[idx] + '.png').replace('//', '/'))
        except:
            img = Image.open((self.dataset_dir + '/image/' + self.train_list[idx] + '.bmp').replace('//', '/')).convert('I')
            mask = Image.open((self.dataset_dir + '/mask/' + self.train_list[idx] + '.bmp').replace('//', '/'))
...
class TestSetLoader(Dataset):
    ...
    def __getitem__(self, idx):
        try:
            img = Image.open((self.dataset_dir + '/image/' + self.test_list[idx] + '.png').replace('//', '/')).convert('I')
            mask = Image.open((self.dataset_dir + '/mask/' + self.test_list[idx] + '.png').replace('//', '/'))
        except:
            img = Image.open((self.dataset_dir + '/image/' + self.test_list[idx] + '.bmp').replace('//', '/')).convert('I')
            mask = Image.open((self.dataset_dir + '/mask/' + self.test_list[idx] + '.bmp').replace('//', '/'))
...
class EvalSetLoader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        mask_gt = Image.open(self.dataset_dir + '/mask/' + self.test_list[idx] + '.png')
